 ...
 * puts them in .creativeagency-portfolio-load and lays the Isotope grid out again.
 * No jQuery.
 */
(function () {
  'use strict';
  ...
  function run() {
    ...
    buttons.forEach(function (button) {
      button.addEventListener('click', function (e) {
        ...
        var data = {
          'action': 'creativeagency_portfolio_ajax',
        ...
        UI.request(settings.action_url, { method: 'POST', data: data }).then(function (html) {
          UI.toElements('.creativeagency-portfolio-load').forEach(function (el) {
            el.innerHTML = html;
          });

          UI.isotope('.creativeagency-portfolio', 'reloadItems');
