...
/**
 *
 * Creative_Agency Review Contents section widget.
 *
 * @since 1.0
 */
class Creative_Agency_Review_Contents extends Widget_Base {

	public function get_name() {
		return 'creativeagency-review-contents';
	}

	public function get_title() {
		return __( 'Review Contents', 'creativeagency-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'reviews_content',
			[
				'label' => __( 'Review Contents', 'creativeagency-companion' ),
			]
        );
		...
		$this->add_control(
            'reviews_contents', [
                ...
                'fields' => [
                    [
                        'name' => 'reviewr_img',
                        'label' => __( 'Reviewer Image', 'creativeagency-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::MEDIA,
                        'default' => [
                            'url' => Utils::get_placeholder_image_src()
                    ...
                    [
                        'name' => 'review_txt',
                        'label' => __( 'Review Text', 'creativeagency-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'reviewer_name',
                        'label' => __( 'Reviewer Name', 'creativeagency-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '- MITHILA', 'creativeagency-companion' ),
                    ],
                    [
                        'name' => 'reviewer_designation',
                        'label' => __( 'Reviewer Designation', 'creativeagency-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Designer at Colorlib', 'creativeagency-companion' ),
                    ],
                ],
                'default'   => [
                    [
                        ...
                        'reviewer_name'         => __( '- MITHILA', 'creativeagency-companion' ),
                        'reviewer_designation'  => __( 'Designer at Colorlib', 'creativeagency-companion' ),
                    ],
                    [
                        'reviewr_img'           => [
                            'url'               => Utils::get_placeholder_image_src(),
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Review Section', 'creativeagency-companion' ),
        ...
        $this->add_control(
            'rev_txt_col', [
                'label' => __( 'Review Text Color', 'creativeagency-companion' ),
        ...
        $this->add_control(
            'rev_name_col', [
                'label' => __( 'Reviewer Name Color', 'creativeagency-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'rev_desig_col', [
                'label' => __( 'Reviewer Designation Color', 'creativeagency-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    <div class="testmonial_area testimonial_bg overlay2" <?php echo creativeagency_inline_bg_img( esc_url( $bg_img ) ); ?>>
                    ...
                    <div class="testmonial_active owl-carousel">
                        ...
                        if( is_array( $reviews ) && count( $reviews ) > 0 ){
                            foreach ( $reviews as $review ) {
                                ...
                                $reviewr_img   = !empty( $review['reviewr_img']['id'] ) ? wp_get_attachment_image( $review['reviewr_img']['id'], 'creativeagency_client_img_116x116', '', array('alt' => $reviewer_name . ' image' ) ) : '';
