...
class Creative_Agency_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'creativeagency_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Creative_Agency ] Social Links', 'creativeagency-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'creativeagency-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'creativeagency-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'creativeagency-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'creativeagency-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'creativeagency-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'creativeagency-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'creativeagency-companion'); ?></label>
...
} // Class creativeagency_social_links ends here


// Register and load the widget
function creativeagency_social_links_widget_load() {
	register_widget( 'Creative_Agency_social_links' );
}
add_action( 'widgets_init', 'creativeagency_social_links_widget_load' );