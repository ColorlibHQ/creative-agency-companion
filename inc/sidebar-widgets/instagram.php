...
----------------------------------------*/
class creativeagency_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('creativeagency_instagram_photo',esc_html__('[ Creative_Agency ] Intagram Photo','creativeagency-companion'),array(
			'description' => esc_html__('Creative_Agency Instagram Photo Widget','creativeagency-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'creativeagency-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'creativeagency-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'creativeagency-companion'); ?></label>
...
if(!function_exists('creativeagency_instagram_widgets')):
	function creativeagency_instagram_widgets(){
		register_widget('creativeagency_instagram_photo');
	}
	add_action('widgets_init','creativeagency_instagram_widgets');
endif;
